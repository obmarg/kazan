defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.Pod do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ObjectMeta.t() | nil,
          spec: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodSpec.t() | nil,
          status: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodStatus.t() | nil
        }
  defstruct [:metadata, :spec, :status]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ObjectMeta
  field :spec, 2, optional: true, type: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodSpec
  field :status, 3, optional: true, type: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodStatus
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodCondition do
  @moduledoc false
  use Protobuf, syntax: :proto2
...
defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodList do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta.t() | nil,
          items: [K8s.Io.Apiserver.Pkg.Apis.Example.V1.Pod.t()]
        }
  defstruct [:metadata, :items]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta
  field :items, 2, repeated: true, type: K8s.Io.Apiserver.Pkg.Apis.Example.V1.Pod
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodSpec do
  @moduledoc false
  use Protobuf, syntax: :proto2
  ...
  field :nodeSelector, 7,
    repeated: true,
    type: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodSpec.NodeSelectorEntry,
    map: true
...
defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodSpec.NodeSelectorEntry do
  @moduledoc false
...
defmodule K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodStatus do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          phase: String.t(),
          conditions: [K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodCondition.t()],
          message: String.t(),
          reason: String.t(),
          hostIP: String.t(),
          podIP: String.t(),
  ...
  defstruct [:phase, :conditions, :message, :reason, :hostIP, :podIP, :startTime]

  field :phase, 1, optional: true, type: :string
  field :conditions, 2, repeated: true, type: K8s.Io.Apiserver.Pkg.Apis.Example.V1.PodCondition
