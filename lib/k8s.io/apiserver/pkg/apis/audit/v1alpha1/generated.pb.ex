defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Event do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          sourceIPs: [String.t()],
          userAgent: String.t(),
          objectRef: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.ObjectReference.t() | nil,
  ...
  field :objectRef, 11,
    optional: true,
    type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.ObjectReference
  ...
  field :annotations, 17,
    repeated: true,
    type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Event.AnnotationsEntry,
    map: true
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Event.AnnotationsEntry do
  @moduledoc false
...
defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.EventList do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta.t() | nil,
          items: [K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Event.t()]
        }
  defstruct [:metadata, :items]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta
  field :items, 2, repeated: true, type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Event
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.GroupResources do
  @moduledoc false
  use Protobuf, syntax: :proto2
...
defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.ObjectReference do
  @moduledoc false
  use Protobuf, syntax: :proto2
  ...
  defstruct [:resource, :namespace, :name, :uid, :apiVersion, :resourceVersion, :subresource]
  ...
  field :subresource, 7, optional: true, type: :string
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Policy do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ObjectMeta.t() | nil,
          rules: [K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.PolicyRule.t()],
          omitStages: [String.t()]
        }
  defstruct [:metadata, :rules, :omitStages]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ObjectMeta
  field :rules, 2, repeated: true, type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.PolicyRule
  field :omitStages, 3, repeated: true, type: :string
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.PolicyList do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta.t() | nil,
          items: [K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Policy.t()]
        }
  defstruct [:metadata, :items]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta
  field :items, 2, repeated: true, type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.Policy
end

defmodule K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.PolicyRule do
  @moduledoc false
  use Protobuf, syntax: :proto2
  ...
  @type t :: %__MODULE__{
          ...
          userGroups: [String.t()],
          verbs: [String.t()],
          resources: [K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.GroupResources.t()],
          namespaces: [String.t()],
  ...
  field :resources, 5,
    repeated: true,
    type: K8s.Io.Apiserver.Pkg.Apis.Audit.V1alpha1.GroupResources
