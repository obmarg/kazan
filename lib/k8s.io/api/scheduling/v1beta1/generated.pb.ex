defmodule K8s.Io.Api.Scheduling.V1beta1.PriorityClass do
  @moduledoc false
...
defmodule K8s.Io.Api.Scheduling.V1beta1.PriorityClassList do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          metadata: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta.t() | nil,
          items: [K8s.Io.Api.Scheduling.V1beta1.PriorityClass.t()]
        }
  defstruct [:metadata, :items]

  field :metadata, 1, optional: true, type: K8s.Io.Apimachinery.Pkg.Apis.Meta.V1.ListMeta
  field :items, 2, repeated: true, type: K8s.Io.Api.Scheduling.V1beta1.PriorityClass
end
