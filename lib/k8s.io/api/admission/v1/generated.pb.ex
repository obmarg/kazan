defmodule K8s.Io.Api.Admission.V1.AdmissionRequest do
  @moduledoc false
...
defmodule K8s.Io.Api.Admission.V1.AdmissionResponse do
  @moduledoc false
  use Protobuf, syntax: :proto2
  ...
  field :auditAnnotations, 6,
    repeated: true,
    type: K8s.Io.Api.Admission.V1.AdmissionResponse.AuditAnnotationsEntry,
    map: true
end

defmodule K8s.Io.Api.Admission.V1.AdmissionResponse.AuditAnnotationsEntry do
  @moduledoc false
...
defmodule K8s.Io.Api.Admission.V1.AdmissionReview do
  @moduledoc false
  use Protobuf, syntax: :proto2

  @type t :: %__MODULE__{
          request: K8s.Io.Api.Admission.V1.AdmissionRequest.t() | nil,
          response: K8s.Io.Api.Admission.V1.AdmissionResponse.t() | nil
        }
  defstruct [:request, :response]

  field :request, 1, optional: true, type: K8s.Io.Api.Admission.V1.AdmissionRequest
  field :response, 2, optional: true, type: K8s.Io.Api.Admission.V1.AdmissionResponse
end
