defmodule RequestTest do
  ...
  describe "Request.create" do
    ...
    test "building a GET request with path parameters" do
      {:ok, request} =
        Request.create("listCoreV1NamespacedPod", %{"namespace" => "test"})
    ...
    test "building a GET request with query parameters" do
      {:ok, request} =
        Request.create("listCoreV1PodForAllNamespaces", %{"pretty" => "true"})
    ...
    test "building a POST request" do
      ...
      {:ok, request} =
        Request.create("createCoreV1NamespacedBinding", %{
          "namespace" => "test",
          "body" => body_data
        })
    ...
    test "building a PATCH request" do
      ...
      {:ok, request} =
        Request.create("patchCoreV1Namespace", %{
          "name" => "test",
          "body" => body_data
        })
